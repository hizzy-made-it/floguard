...
export const POSTS = [
  {
    ...
    content: [
      ...
      { type: "ul", items: [
        "Length and depth of the trench (longer, deeper runs cost more)",
        "Soil type and how high your water table sits",
        "Whether a sump pump is needed for flat lots or low spots",
        "How far water must travel to a safe discharge point",
        "Landscaping, hardscape, or utilities the crew has to work around",
      ] },
      ...
      { type: "p", text: "We provide free, on-site drainage assessments across Central Florida. You'll get a clear plan and an honest price — no pressure. Book yours and stop guessing about standing water." },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "A French drain is a fabric-lined, gravel-filled trench with a perforated pipe. It captures groundwater and surface runoff and carries it away by gravity. It's the collection half of the system." },
      { type: "h2", text: "What a sump pump does" },
      { type: "p", text: "When gravity alone can't move water to a safe discharge point — think flat lots or a high water table — the drain routes to a sump basin. The pump automatically switches on and lifts the water out through a solid discharge line. It's the muscle that makes drainage work where gravity can't." },
      { type: "h2", text: "When you need both" },
      { type: "ul", items: [
        "Flat lots with no natural downhill discharge",
        "Homes with a high water table (common near the coast)",
      ...
      { type: "p", text: "Not sure which your home needs? That's exactly what our free site evaluation determines." },
    ],
  },
  {
    ...
    content: [
      ...
      { type: "ul", items: [
        "Pooling water against the foundation walls after rain",
        "Hairline cracks in walls, floors, or the slab that keep growing",
        "Musty smells, damp crawlspaces, or visible moisture indoors",
        "Doors and windows that suddenly stick or won't close right",
        "Soil pulling away from the foundation, or mulch and dirt washing out",
      ] },
      { type: "p", text: "Individually, any one of these can seem minor. Together, they point to water pressing against — and under — your home." },
      { type: "h2", text: "Why it gets worse fast in Florida" },
      { type: "p", text: "Saturated soil creates hydrostatic pressure that pushes moisture through concrete. Our rainy season delivers that pressure in intense bursts, so a small issue can accelerate quickly between storms." },
      { type: "p", text: "The fix is to relieve that pressure with a properly designed drainage system that keeps water away from the foundation entirely. If you're seeing any of these signs, get an assessment now — foundation repairs cost far more than prevention." },
    ],
  },
  {
    ...
    content: [
      ...
      { type: "ul", items: [
        "Clear gutters and check that downspouts extend away from the house",
        "Walk the yard during a storm and note where water pools",
        "Look for soil erosion, exposed roots, or washed-out mulch beds",
        "Test any existing sump pump before you need it",
        "Check that catch basins and drains aren't clogged with debris",
      ] },
      { type: "h2", text: "Why timing matters" },
      { type: "p", text: "The best time to fix drainage is before the ground is fully saturated. Installing a system during the dry stretch means it's ready and tested when the heavy storms hit — instead of scrambling after your yard has already flooded." },
      ...
      { type: "p", text: "If last summer left you with a swamped yard, don't repeat it. Book a free assessment and we'll storm-proof your drainage before the season peaks." },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "A catch basin is a grated box set into a low point that collects surface water and channels it into an underground pipe. Perfect for patios, driveways and the spots where water always seems to gather." },
      { type: "h2", text: "Grading & swales" },
      { type: "p", text: "Sometimes the real problem is that the ground slopes the wrong way. Re-grading and shaping gentle swales redirect water away from the house and toward a controlled discharge — no digging a full trench required." },
      { type: "h2", text: "The right combination" },
      { type: "ul", items: [
      ...
      { type: "p", text: "A great drainage plan uses the right mix of these tools for your specific yard. That's the difference between a fix that lasts and one that just moves the puddle a few feet." },
    ],
  },
  {
