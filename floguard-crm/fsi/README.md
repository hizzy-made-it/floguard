...
| `sql/015` gold-segment basin rule | Applied 2026-09-17 (two passes). Deep (≥1 m) closed basins reach `gold_segment` regardless of soil; reason `closed_basin`. 8,714 inland parcels now gold, but they sit in `maybe` under countywide cuts. Per-market bands is the open question |
| `sql/014` weight rebalance | Applied 2026-09-17. Static DEPR 0.20; MHS claim heat 0.12 / risk 0.38. DeLand now has must/should parcels; Orange City, Deltona, DeBary still ~0 because `gold_segment` (+14) needs claim heat ≥ 0.35 |
